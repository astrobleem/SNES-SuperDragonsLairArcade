...
This script:
1. Finds all .ogg files in Daphne content directory
...
from paths import DAPHNE_CONTENT, DAPHNE_FRAMEFILE, DISTRIBUTION, TOOLS_DIR

# Paths
OUTPUT_DIR = DISTRIBUTION
MSU_CONVERTER = TOOLS_DIR / "msu1pcmwriter.py"
...
def get_track_mapping():
    ...
    with open(DAPHNE_FRAMEFILE, 'r') as f:
...
def main():
    ...
    for track_num, audio_file in sorted(track_map.items()):
        ogg_path = DAPHNE_CONTENT / audio_file
