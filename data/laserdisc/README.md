...
2. **`DLCDROM/`** — Directory containing the actual .m2v (video) and .ogg
...
2. Copy the framefile to `data/laserdisc/framefile/dlcdrom.TXT`.
3. Copy all `.m2v` and `.ogg` segment files into `data/laserdisc/DLCDROM/`.
