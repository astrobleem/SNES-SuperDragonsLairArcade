...
- `turbo.gfx_sprite`: Legacy racing callout; unused for Dragon's Lair and should be left unreferenced.
- `brake.gfx_sprite`: Legacy racing warning; unused for Dragon's Lair and should be left unreferenced.
- `dashboard.gfx_sprite`: Legacy HUD dashboard overlay from RoadBlaster; unused for Dragon's Lair.
- `super.gfx_sprite`: HUD burst effect when the super state is active.
- `steering_wheel.normal/left/right.gfx_sprite`: Legacy racing wheel trio; unused for Dragon's Lair.
